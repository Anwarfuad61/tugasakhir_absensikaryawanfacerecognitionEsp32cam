    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <?php
// Pastikan variabel $name sudah diinisialisasi sebelumnya, misalnya dari session:
session_start();
$name = $_SESSION['name'] ?? ''; // Misalnya mengambil face_id dari session

// Query untuk menghitung jumlah 'alpa' dalam bulan ini
$sql = "SELECT COUNT(*) as alpa_count
        FROM absensi
        ...
        AND absensi.status = 'alpa'";

// Eksekusi query
$result = $koneksi->query($sql);
$row = $result->fetch_assoc();

// Cek apakah jumlah alpa mencapai atau melebihi 10
if ($row['alpa_count'] >= 10) {
?>
    <div class="card">
